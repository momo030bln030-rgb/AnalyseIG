...
class InstagramFullScraper:
    ...
    def get_profile_data(self, username):
        ...
        try:
            ...
            print(f"[OK] Profil geladen: {data['username']} ({data['follower_count']:,} Follower)")
            return data
    ...
    def generate_full_report(self, username):
        ...
        print(f"\n{'='*80}")
        print(f"{'INSTAGRAM VOLLSTAENDIGER DATEN-REPORT':^80}")
        print(f"{'='*80}\n")
        ...
        print("\n" + "="*80)
        print("[3] OEFFENTLICHE KOMMENTARE")
        print("="*80)
        ...
        if tags_data['mentions']:
            ...
            print(f"\nErwahnungen ({len(tags_data['mentions'])}): {mentions_str}")
        
        # 6. ENGAGEMENT-STATISTIKEN
        print("\n" + "="*80)
        print("[6] ENGAGEMENT-STATISTIKEN")
        print("="*80)
...
if __name__ == "__main__":
    ...
    # ====== KONFIGURATION ======
    target_username = "cristiano"  # HIER DEINEN WUNSCH-ACCOUNT EINGEBEN
    # ============================
